      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?= $usuario->comentarioPreferencias ?>
            </td>
          </tr>
          <tr>
            <td>Foto de perfil</td>
            <td>
              <?php if (isset($usuario->imagenUsuario)): ?>
                <img src="/avatar/<?= $usuario->imagenUsuario ?>" class="img-fluid rounded mb-2" alt="..."
                style="height: 400px;width: 300px;">
        
              <?php else: ?>
                <p>El usuario
                  <?= "<strong>" .  $usuario->nombre . " ".$usuario->apellido_Paterno." ".$usuario->apellido_Materno."</strong>" ?> no cuenta con una foto de perfil, favor de cargar una
                </p>
              <?php endif ?>
...
<div class="contenedor-botones" style="display:flex; justify-content:center; padding-bottom: 50px;">
  <a href="<?= base_url('/Administrador/editUsr/' . $usuario->numeroControl) ?>" style="text-decoration:none;">
  ...
  <a href="<?= base_url('/Administrador/usuariosTabla') ?>" style="text-decoration:none;">
