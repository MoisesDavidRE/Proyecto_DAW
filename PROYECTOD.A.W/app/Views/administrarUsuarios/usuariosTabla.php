    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/Administrador/agregarUsr" method="post" action="cargar.php" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        <label for="comentarioPreferencias" class="form-label">Comentarios o preferencias adicionales</label>
