...
<div class="container" style="padding-left:200px">
    <div class="row">
        <div>
            ...
            <h2 align="center" class="mb-5">Acuario Deimar te da la bienvenida </h2>
        ...
        <div class="card col-3">
            ...
            <div class="card__content">
                ...
                <button type="button" class="btn btn-outline-primary"
                    onclick="location.href='/Cliente/animalesTabla'">Ir a
                    Animales</button>
            </div>
        </div>
        ...
        <div class="card col-3">
            ...
            <div class="card__content">
                ...
                <p class="card__description">Aquí puedes consultar las reservaciones que has hecho hasta el momento</p>
                <button type="button" class="btn btn-outline-primary"
                    onclick="location.href='/Cliente/reservacionesTabla'">Ir
        ...
        <div class="card col-3">
            ...
            <div class="card__content">
                ...
                <p class="card__description">En este módulo puedes ver las atracciones ofertadas por el acuario, puedes hacer una reservación de la atracción</p>
                <button type="button" class="btn btn-outline-primary"
