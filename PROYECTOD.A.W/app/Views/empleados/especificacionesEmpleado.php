...
<div class="contenedor-botones" style="display:flex; justify-content:center;">
  <a href="<?= base_url('/Administrador/editEm/' . $empleado->idEmpleado) ?>" style="text-decoration:none;">
  ...
  <a href="<?= base_url('/Administrador/delEm/' . $empleado->idEmpleado) ?>" style="text-decoration:none;padding-right:15px">
