...
<nav class="navbar navbar-expand-lg mb-3 " style="background-color:#22ccdb">
    <a href="/"><img src="\icons\logo-corto.png" width="150px" style="position:absolute;left:1%;top:1%;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav navbar-brand   mb-lg-0">
                <li class="nav-item" style="position:absolute; left:23%;top:10%">
                    <a class="nav-link active" aria-current="page" href="/publico">
                ...
                <li class="nav-item" style="position:absolute; left:37%;top:10%">
                    <a class="nav-link active" aria-current="page" href="/publico/animales">

                        <img src="\icons\tortuga.png" style="width:40px; height: 40px;"> Animales
                    </a>
                </li>
                <li class="nav-item" style="position:absolute; left:53%;top:10%">
                    <a class="nav-link active" aria-current="page" href="/publico/reservaciones">
                ...
                <li class="nav-item" style="position:absolute; right:23%;top:10%;">
                    <a class="nav-link active" aria-current="page" href="/publico/atracciones">
                        <img src="\icons\atr.png" style="width:40px; height: 40px;"> Atracciones</a>
                </li>
                <button class="Btn-salir" onclick="location.href='/'" style="position:absolute; top:15%;right:2%;">
                    ...
                    <div class="text-salir">Iniciar sesión</div>
                </button>

                <button class="Btn-salir" onclick="location.href='/registrar'" style="position:absolute; top:15%;right:8%;">
                    <div class="sign-salir">
                    <img src="\icons\registrar.png" style="width:20px; height: 20px;">
                    </div>
                    <div class="text-salir">Registrarse</div>
                </button>
            </ul>
        </div>
    </div>
