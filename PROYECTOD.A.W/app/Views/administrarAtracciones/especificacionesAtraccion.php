...
<div class="contenedor-botones" style="display:flex; justify-content:center;">
    <a href="<?= base_url('/Administrador/editAtraccion/' . $atraccion->idAtraccion) ?>" style="text-decoration:none;">
    ...
    <a href="<?= base_url('/Administrador/delAtraccion/' . $atraccion->idAtraccion) ?>"
        ...
        <button class="noselect"><span class="text">Borrar</span><span class="icon"><svg
    ...
    <a href="<?= base_url('/Administrador/atraccionesTabla') ?>" style="text-decoration:none;">
