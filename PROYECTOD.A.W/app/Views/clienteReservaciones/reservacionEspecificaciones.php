...
<div class="contenedor-botones" style="display:flex; justify-content:center;">
  <a href="<?= base_url('/Cliente/editReservacion/' . $reservacion->idReservacion) ?>" style="text-decoration:none;">
  ...
  <a href="<?= base_url('/Cliente/delReservacion/' . $reservacion->idReservacion) ?>" style="text-decoration:none;padding-right:15px">
  ...
  <a href="<?= base_url('/Cliente/reservacionesTabla') ?>" style="text-decoration:none;">
