...
<h1 class="mb-5" align="center">Tus reservaciones</h1>
        ...
        <div class="container mb-3" style="background-color:white;height:40px; border-radius:7px;">
                <div class="row">
                    <div class="col-2">
                        ...
                        <a href="<?= base_url('/tablaReservaciones'); ?>" style="position:absolute;left:61.5%;">
                            <button type="button" class="btn btn-outline-success mb-5" data-bs-toggle="modal">
                                Descargar tabla de reservaciones
                            </button>
                        </a>
                        <a href="<?= base_url('/Cliente/buscarReser'); ?>" style="position:absolute;left:75.8%;">
                            <button type="button" class="btn btn-outline-success mb-5" data-bs-toggle="modal">
                                Buscar reservación
                            </button>
                        </a>
            ...
            <table class='table table-bordered table-striped'>
                <thead>
                    <tr>
                        <th style="background-color: #fa6900;">Reservación a nombre de:</th>
                        <th style="background-color: #fa6900;">Estatus</th>
                ...
                <tbody class="table-group-divider">
                    <?php foreach ($reservaciones as $reservacion): ?>
                        <tr>
                            ...
                            <td style="width:150px"><a href="<?= base_url('/Cliente/especificacionesReservacion/' . $reservacion->idReservacion ); ?>"
            ...
            Se muestran <?=count($reservaciones) ?> registros de un total de <?=$registros?>
            <?= $pager->links(); ?>
        </div>
    </div>
</div>
