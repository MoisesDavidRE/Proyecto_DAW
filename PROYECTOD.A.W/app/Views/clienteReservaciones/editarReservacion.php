...
<form action="<?= base_url('Cliente/editReservacion/' . $reservacion->idReservacion); ?>" method="POST"
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input class="form-control" name="estatus" type="text" value="<?= $reservacion->estatus ?>"readonly>
              </td>
            </tr>
            <tr>
