...
<div class="container">
    <div class="row mb-3">
        <div class="col-12">
            <h1 align="center">Buscar reservación</h1>

            <form action="<?= base_url('/Administrador/buscarReservacion'); ?>" method="GET">

                <div class="col-5 mb-3">
                    <label for="Buscador">Buscar por: </label>
                    <select name="Buscador" class="form-control">
                        <option value="Todo">Mostrar todo</option>
                        <option value="idReservacion">ID de la reservación</option>
                        <option value="atraccion">Nombre de la atracción</option>
                        <option value="usuario">Usuario</option>
                        <option value="estatus">Estatus de la reservación</option>
                    </select>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <table class='table table-stripped'>
                <thead>
                    <tr>
                    <th style="background-color: #fa6900;">ID</th>
                        <th style="background-color: #fa6900;">Usuario que reservó</th>
                        <th style="background-color: #fa6900;">Nombre de la atracción</th>
                ...
                <tbody class="table-group-divider">
                    <?php $db = \Config\Database::connect(); foreach ($reservaciones as $reservacion): ?>
                        <tr>
                        <td>
