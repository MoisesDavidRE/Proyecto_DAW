...
<div class="container ">
    <div class="row">
        <div class="col-12">
            <div class="container mb-3" style="background-color:white;height:40px; border-radius:7px;">
                <div class="row">
                    <div class="col-2">
                        ...
                        <a href="<?= base_url('/Administrador/buscarAn'); ?>"
                            style="position:absolute;left:77.5%;">
            ...
            <table class='table table-bordered table-striped-columns table-striped' style="border-radius: 7px;">
                <thead>
                    <tr>
                ...
                <tbody class="table-group-divider">
                    <?php foreach ($animales as $animal): ?>
                        <tr>
                            ...
                            <td style="width: 50px;"><a href="<?= base_url('/Administrador/especificacionesAnimal/' . $animal->numeroIdentificador); ?>"
                                    style="display:flex;justify-content:center;max-width:50px;">
                                    <img src="\especs.png" style="width:30px; height: 30px;">
                                </a>
                            </td>
                            <td style="width: 50px;">
                                <a href="<?= base_url('/Administrador/editAn/' . $animal->numeroIdentificador); ?>">
                                  
                                    <img src="\editar.png" style="width:30px; height: 30px;">
                                    
                                </a>
                            </td>
                            <td style="width: 50px;">
                                <a href="<?= base_url('/Administrador/delAn/' . $animal->numeroIdentificador); ?>">
                                <img src="\del.png" style="width:30px; height: 30px;">
                                </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
