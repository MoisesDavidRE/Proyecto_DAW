...
<form action="<?= base_url('Administrador/editArea/' . $area->idArea); ?>" method="POST" style="margin-bottom: -50px;">
    <?= csrf_field() ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-0">
                        <div class="col-md-8 border">
                            ...
                            <textarea name="descripcion" class="form-control" aria-label="With textarea"
                                style="height: 50%;"><?= $area->descripcion ?></textarea>
                        </div>
                        ...
                        <div class="col-md-4 border">
                            <h5>Tamaño en M²</h5>
                            <input type="text" name="tamanio" value="<?= $area->tamanio . " M²" ?>">
                        </div>
                        <div class="col-md-4 border">
                            <h5>Temperatura en grados Celcius</h5>
                            <input type="text" name="temperatura" value="<?= $area->temperatura ?>">
                        </div>
                        <div class="col-md-3 border">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-3 border">
                            ...
                            <input type="time" value="<?= $area->horaMantenimiento ?>" name="horaMantenimiento">
                        </div>
                        <div class="col-md-5 border">
                            <h5>PH Promedio del área</h5>
                            <input type="text" name="phPromedio" value="<?= $area->phPromedio ?>">
                        </div>
                    </div>
                    <div class="row g-0">
                        <div class="col-md-4 border">
                            <h5>Iluminación</h5>
                            <input type="text" name="iluminacion" value="<?= $area->iluminacion ?>">
                        </div>

                        <div class="col-md-4 border">
                            <h5>Tipo de filtracion de agua</h5>
                            <input type="text" name="filtracionAgua" value="<?= $area->filtracionAgua ?>">
                        </div>

                        <div class="col-md-3 border">
                            <h5>Número máximo de habitantes</h5>
                            <input type="text" name="noHabitantesMax" value="<?= $area->noHabitantesMax ?>">
                        </div>
                    </div>
                </div>
            </div>
